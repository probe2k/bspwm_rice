...
(("switch"   @keyword) (#set! conceal "󰔡"))
(("default"  @keyword) (#set! conceal  "󰫱"))
(("break"    @keyword.return) (#set! conceal  ""))
...
(("interface"       @keyword) (#set! conceal "󰙅"))
...
(((identifier) @field (#eq? @field "assert"     )) (#set! conceal "󰀫"))
